...
export const config = {
  ...
  openpay: {
    merchantId: process.env.OPENPAY_MERCHANT_ID || "mkk673wuxmi4xvii20cf", // Prolab Sandbox
    // merchantId: process.env.OPENPAY_MERCHANT_ID || "my8wzu8jkspx06fahw8t", // Labtech
    privateKey:
      process.env.OPENPAY_PRIVATE_KEY || "sk_3c78be60065d4f89ab1eb7ef2a060ac7", // Prolab Sandbox
    // process.env.OPENPAY_PRIVATE_KEY || "sk_39c3d70d50e642f583ce6207d8edd2fe", // Labtech
  ...
  urls: {
    ...
    // "http://localhost:8443/datasnap/rest/TSMREST",
  },
};
